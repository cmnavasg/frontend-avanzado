...
export class OffersListComponent implements OnChanges {
  ...
  offersStudy: Offer[] = [];
  offersOther: Offer[] = [];
  displayedColumnsOffers = ['puesto', 'empresa', 'familia', 'fecha', 'provincia', 'municipio', 'inscrito', 'acciones'];
  displayedColumnsOffersOther = ['puesto', 'empresa', 'familia', 'fecha', 'provincia', 'municipio'];
  constructor() {}
