...
export class AppSettings {
  ...
  public static readonly API_ENDPOINT_LOGIN = AppSettings.API_ENDPOINT + 'login';
  ...
  public static readonly API_ENDPOINT_PROVINCES =
    AppSettings.API_ENDPOINT + 'provinces';
  public static readonly API_ENDPOINT_MUNICIPES =
    AppSettings.API_ENDPOINT + 'municipes';
  public static readonly API_ENDPOINT_DOCUMENTS =
    AppSettings.API_ENDPOINT + 'documents';
  public static readonly API_ENDPOINT_LEVELS =
    AppSettings.API_ENDPOINT + 'levels';
  public static readonly API_ENDPOINT_INSTITUTIONS =
    AppSettings.API_ENDPOINT + 'institutions';
  public static readonly API_ENDPOINT_GRADES =
